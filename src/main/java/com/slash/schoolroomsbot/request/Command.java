...
public enum Command {
    ...
    USER("school U", LINKING, "Links a user (e.g. school UJustATechGuyOuttaThere)", 5),
    PERSON_OF_INTEREST("school P", LINKING, "Links a person of interest (e.g. school PTristan Dexpun)", 5),
    MAIN("school main", WIKI, "Gets the link to the main page"),
    USEFUL("school useful", WIKI, "Gets the starter links"),
    PAGE("school page", WIKI, "Gets a link to the specified page", 0, List.of("page")),
